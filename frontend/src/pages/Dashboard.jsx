                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {PLATFORMS.map(p => {
                                ...
                                return (
                                    <div
                                        key={p.key}
                                        className={`relative border-2 rounded-xl p-4 transition ${conn.isConnected
                                    ...
                                    >
                                        ...
                                        {conn.isConnected ? (
                                            ...
                                            <button
                                                ...
                                                className={`mt-2 w-full text-xs py-2 rounded-lg text-white font-medium transition ${p.comingSoon
                    ...
                    <>
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {TONES.map(t => (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-lg text-sm border-2 transition ${aiTone === t.key
                            ...
                            <div className="mb-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {PLATFORMS.filter(p => !p.comingSoon).map(p => (
                                        <label
                                            key={p.key}
                                            className={`flex items-center gap-2 cursor-pointer px-4 py-2 rounded-lg border-2 text-sm transition ${aiPlatforms.includes(p.key)
                            ...
                            <button
                                ...
                                disabled={aiLoading}
                                className={`w-full py-3 rounded-lg text-white font-semibold transition ${aiLoading
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {PLATFORMS.filter(p => !p.comingSoon).map(p => {
                                        ...
                                        return (
                                            <label
                                                key={p.key}
                                                className={`flex items-center gap-2 cursor-pointer px-4 py-2 rounded-lg border-2 text-sm transition ${isSelected
                                                        ? `${p.borderColor} ${p.bgColor} font-medium`
                                                        : 'border-gray-200 bg-white'
                            ...
                            {PLATFORMS.filter(p => selected[p.key]).map(p => (
                                <div key={p.key} className="mb-4">
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <span className={`text-xs ${content[p.key].length > p.charLimit * 0.9
                                                ? 'text-red-500'
                                                : 'text-gray-400'
                                            }`}>
                                ...
                                <div className="flex gap-3">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`px-5 py-2 rounded-lg text-sm font-medium border-2 transition ${postMode === mode.key
                            ...
                            {/* Result message */}
                            {postResult && (
                                <div className={`mb-4 px-4 py-3 rounded-lg text-sm ${postResult.success
                            ...
                            <button
                                ...
                                className={`w-full py-3 rounded-xl text-white font-semibold text-base transition ${postLoading
                                    ...
                                    <div key={post._id} className="border border-gray-200 rounded-xl p-4">
                                        <div className="flex items-center justify-between mb-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <span className={`text-xs px-2 py-1 rounded-full font-medium ${post.overallStatus === 'published' ? 'bg-green-100 text-green-700' :
